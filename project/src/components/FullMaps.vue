...
export default {
  ...
  data() {
    return {
      accessToken:
        "pk.eyJ1IjoibnVlbHZzIiwiYSI6ImNsYjJhYjhwZzAyc3kzb3MwY2phbHpmbXcifQ.dgj4J7DNpOHg9k7kGBuGdw",
    };
  },
  mounted() {
          ...
          new mapboxgl.Popup()
            ...
            .setHTML(
              "<h4>Informasi Lokasi</h4>" +
                ...
                "<td>Nama </td>" +
                "<td> : " +
                e.features[0].properties.titik_sample +
                "</td>" +
                "</tr>" +
                "<tr>" +
                "<td>Lokasi </td>" +
                ...
                "<td>Komoditas </td>" +
                "<td> : " +
                e.features[0].properties.comodity +
                "</td>" +
                "</tr>" +
                "<tr>" +
                "<td>Karbon Tanah </td>" +
                "<td> : " +
                e.features[0].properties.karbon_tanah +
                "</td>" +
                "</tr>" +
                "<tr>" +
                "<td>Karbon Tanaman </td>" +
                "<td> : " +
                e.features[0].properties.karbon_tanaman +
                "</td>" +
                "</tr>" +
                "<tr>" +
                "<td>Tanggal </td>" +
                "<td> : " +
                e.features[0].properties.date_pretty +
                "</td>" +
                "</tr>" +
                "<tr>" +
                "<td>Citra NIR</td>" +
                "<td> : <img src=" +
                e.features[0].properties.NIR_url +
                "></td>" +
                "</tr>" +
                "</table>" +
                "<a href='/visual_page/" +
