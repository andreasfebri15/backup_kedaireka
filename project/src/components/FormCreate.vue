<template>
  <v-container id="create">
    <v-form v-model="valid" id="model_form">
      <v-container id="container-1">
        <v-row class="row" id="form_create">
          <v-col class="tags">Tanggal Upload</v-col>
          <v-col md="4" id="tanggal">
            <v-text-field
              v-model="date"
              class="input"
              name="date"
        ...
        <v-row class="row">
          ...
          <v-col md="4">
            <v-select
              v-model="hst"
              class="input"
              label="Pilih Hari Setelah Tanam"
              :items="['HST 1', 'HST 2', 'HST 3']"
              required
            >
            </v-select>
          </v-col>
    ...
    >
      <v-btn
        ...
        style="padding-top: 10px; padding-bottom: 40px; font-size: 20px"
      >
        Upload
      </v-btn>
    </router-link>
...
export default {
  ...
  methods: {
    ...
    submitForm: async function () {
      ...
      axios
        .post(
          "https://nl227f95td.execute-api.us-east-1.amazonaws.com/dpl/maps",
          {
            uuid: this.uuid,
      ...
      const url =
        "https://nl227f95td.execute-api.us-east-1.amazonaws.com/dpl/kel3-nir/" +
        this.uuid +
        ".png";
