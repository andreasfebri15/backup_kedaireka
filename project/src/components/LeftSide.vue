<template>
  <!-- Side Bar Menu -->
  <v-navigation-drawer class="nav_bg_color" rail location="left">
    <!-- Logo Menu ISAI -->
    <v-list class="list">
      <v-list-item class="background_logo">
        <v-img src="../images/1.png" margin="0px" padding="0px"></v-img>
      </v-list-item>
    </v-list>
    ...
    <v-list nav>
      ...
      <router-link to="/main_graph" class="menus">
        <v-list-item prepend-icon="mdi-chart-line" value="grafik"
          >Report Page</v-list-item
        >
      </router-link>
      <router-link to="/kalkulisai" class="menus">
        <v-list-item prepend-icon="mdi-calculator" value="kalkulisai"
          >KalkulIsai</v-list-item
        >
      </router-link>
      <v-divider class="divider"></v-divider>
      <router-link to="/login" class="menus">
        <v-list-item prepend-icon="mdi-account-edit" value="login"
          >Login (Admin)</v-list-item
        >
      </router-link>
    </v-list>
  </v-navigation-drawer>
