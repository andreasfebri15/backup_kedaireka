...
export default {
  ...
  data() {
    return {
      periode: ["HST 1", "HST 2", "HST 3"],
      years: ["2022"],
      datatrenChartData: datatrenChartData,
      items: ["Dashboard", "Report Page Per Titik"],
  ...
  mounted() {
    ...
    axios
      .get(
        "https://nl227f95td.execute-api.us-east-1.amazonaws.com/dpl/maps/all2"
      )
      ...
      .then(
        value =>
          ([
            datatrenChartData.data.labels,
            datatrenChartData.data.datasets[1].data,
            datatrenChartData.data.datasets[0].data,
          ] = value)
      )
      .then(function () {
